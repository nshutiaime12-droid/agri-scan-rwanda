...
DISTRICT_SECTORS: dict[str, list[str]] = {
    ...
    "Burera": ["Bungwe", "Butaro", "Cyanika", "Cyeru", "Gahunga", "Gatebe", "Gitovu", "Kagogo", "Kinoni", "Kinyababa", "Kivuye", "Nemba", "Rugengabari", "Ruhunde", "Rusarabuye", "Rwerere"],
    "Gakenke": ["Busengo", "Coko", "Cyabingo", "Gakenke", "Gashenyi", "Janja", "Kamubuga", "Karambo", "Kivuruga", "Mataba", "Minazi", "Mugunga", "Muhondo", "Muyongwe", "Muzo", "Ruli", "Rusasa", "Rushashi"],
    "Gasabo": ["Bumbogo", "Gatsata", "Gikomero", "Gisozi", "Jabana", "Jali", "Kacyiru", "Kimihurura", "Kimironko", "Kinyinya", "Ndera", "Nduba", "Rusororo", "Rutunga"],
    "Gatsibo": ["Gasange", "Gatsibo", "Gitoki", "Kabarore", "Kageyo", "Kiramuruzi", "Kiziguro", "Muhura", "Murambi", "Ngarama", "Nyagihanga", "Rugarama", "Rwimbogo"],
    "Gicumbi": ["Bukure", "Bwisige", "Byumba", "Cyumba", "Giti", "Kaniga", "Manyagiro", "Miyove", "Muko", "Mutete", "Nyamiyaga", "Nyankenke", "Rubaya", "Rushaki", "Rutare", "Ruvune", "Rwamiko", "Shangasha"],
    "Gisagara": ["Gikonko", "Gishubi", "Kansi", "Kigembe", "Mamba", "Mugombwa", "Mukindo", "Ndora", "Nyanza", "Save"],
    "Huye": ["Gishamvu", "Huye", "Kigoma", "Maraba", "Ruhashya", "Rusatira", "Rwaniro", "Simbi"],
    "Kamonyi": ["Gacurabwenge", "Kayenzi", "Kayumbu", "Mugina", "Musambira", "Ngamba", "Nyarubaka", "Rugarika", "Rukoma", "Runda"],
    "Karongi": ["Bwishyura", "Gashari", "Gishyita", "Gitesi", "Mubuga", "Mutuntu", "Rubengera", "Rugabano", "Ruganda", "Rwankuba", "Twumba"],
    ...
    "Musanze": ["Busogo", "Cyuve", "Gacaca", "Gashaki", "Gataraga", "Kimonyi", "Kinigi", "Muhoza", "Musanze", "Nkotsi", "Nyange", "Rwaza", "Shingiro"],
    "Ngoma": ["Gashanda", "Jarama", "Karembo", "Kazo", "Kibungo", "Mugesera", "Murama", "Mutenderi", "Remera", "Rukira", "Rukumberi", "Rurenge", "Sake", "Zaza"],
    "Ngororero": ["Bwira", "Gatumba", "Hindiro", "Kabaya", "Kavumu", "Matyazo", "Muhanda", "Muhororo", "Ndaro", "Ngororero", "Sovu"],
    ...
    "Nyamagabe": ["Buruhukiro", "Gasaka", "Gatare", "Kaduha", "Kamegeri", "Kibirizi", "Kibumbwe", "Kitabi", "Mbazi", "Mugano", "Musange", "Musebeya", "Mushubi", "Nkomane", "Tare", "Uwinkingi"],
    ...
    "Nyanza": ["Busoro", "Cyabakamyi", "Kibilizi", "Mukingo", "Muyira", "Ntyazo", "Rwabicuma"],
    "Nyarugenge": ["Gitega", "Kanyinya", "Kigali", "Kimisagara", "Mageregere", "Muhima", "Nyakabanda", "Nyamirambo", "Rwezamenyo"],
    "Nyaruguru": ["Busanze", "Cyahinda", "Kibeho", "Kivu", "Mata", "Munini", "Ngera", "Nyabimata", "Nyagisozi", "Ruheru", "Ruramba", "Rusenge"],
    "Rubavu": ["Bugeshi", "Busasamana", "Cyanzarwe", "Gisenyi", "Kanama", "Kanzenze", "Mudende", "Nyakiriba", "Nyamyumba", "Nyundo", "Rubavu", "Rugerero"],
    "Ruhango": ["Bweramana", "Byimana", "Kabagali", "Kinazi", "Mbuye", "Mwendo", "Ntongwe"],
    "Rulindo": ["Base", "Burega", "Bushoki", "Buyoga", "Cyinzuzi", "Cyungo", "Kinihira", "Kisaro", "Masoro", "Mbogo", "Ngoma", "Ntarabana", "Rukozo", "Rusiga", "Shyrongi", "Tumba"],
    "Rusizi": ["Bugarama", "Butare", "Bweyeye", "Gashonga", "Giheke", "Gihundwe", "Gikundamvura", "Gitambi", "Kamembe", "Muganza", "Mururu", "Nkanka", "Nkombo", "Nkungu", "Nyakabuye", "Nyakarenzo", "Nzahaha"],
...
SECTOR_CELLS: dict[str, list[str]] = {
    ...
    "Bigogwe": ["Arusha", "Kijote", "Kora", "Muhe"],
    "Boneza": ["Kabihogo", "Nkira"],
    "Bugarama": ["Pera", "Ryankana"],
    "Bugeshi": ["Buringo", "Butaka", "Hehu", "Kabumba", "Mutovu", "Nsherima", "Rusiza"],
    "Bukure": ["Kivumu"],
    "Bumbogo": ["Musave", "Nkuzuzu"],
    "Bungwe": ["Bungwe", "Bushenya", "Mudugari", "Tumba"],
    "Burega": ["Butangampundu", "Karengeri"],
    "Buruhukiro": ["Bushigishigi", "Gifurwe", "Kizimyamuriro", "Rambya"],
    "Busanze": ["Kirarangombe", "Nkanda", "Runyombyi", "Shororo"],
    "Busasamana": ["Gihonga", "Makoro", "Nyacyonga", "Rusura"],
    "Busengo": ["Birambo", "Butereri", "Byibuhiro", "Kamina", "Kirabo", "Mwumba"],
    "Bushekeri": ["Buvungira", "Mpumbu"],
    "Bushenge": ["Gasheke", "Impala", "Kagatamu", "Karusimbi"],
    "Bushoki": ["Giko", "Mukoto", "Nyirangarama"],
    "Busogo": ["Gisesero", "Sahara"],
    "Busoro": ["Kimirama", "Rukingiro", "Shyira"],
    "Butare": ["Butanda", "Gatereri", "Nyamihanda"],
    "Butaro": ["Muhotora", "Nyamicucu", "Rusumo"],
    "Buyoga": ["Gahororo", "Gitumba", "Ndarage"],
    "Bweramana": ["Buhanda", "Gitisi", "Rwinyana"],
    "Bweyeye": ["Gikungu", "Kiyabo", "Nyamuzi", "Rasano"],
    "Bwira": ["Cyahafi", "Gashubi", "Kabarondo", "Ruhindage"],
    "Bwishyura": ["Gitarama", "Kibuye", "Kiniha", "Nyarusazi"],
    "Bwisige": ["Bwisige", "Gihuke", "Mukono", "Nyabushingitwa"],
    "Byimana": ["Kamusenyi", "Kirengeri", "Mahembe", "Mpanda", "Ntenyo", "Nyakabuye"],
    "Byumba": ["Gacurabwenge", "Gisuna", "Kibali", "Kivugiza", "Ngondore", "Nyamabuye", "Nyarutarama"],
    "Coko": ["Kiruku", "Mbirima", "Nyanza"],
    "Cyabakamyi": ["Kadaho", "Nyabinyenga"],
    "Cyabingo": ["Muhaza", "Muhororo", "Muramba", "Mutanda"],
    "Cyahinda": ["Coko", "Cyahinda", "Gasasa", "Muhambara", "Rutobwe"],
    "Cyanika": ["Gasiza", "Gisovu", "Kabyiniro", "Kagitega", "Kamanyana"],
    "Cyanzarwe": ["Busigari", "Cyanzarwe", "Gora", "Kinyanzovu", "Makurizo", "Rwangara", "Rwanzekuma", "Ryabizige"],
    "Cyato": ["Bisumo"],
    "Cyeru": ["Ndongozi", "Ruyange"],
    "Cyeza": ["Biringaga", "Makera", "Shori"],
    "Cyinzuzi": ["Budakiranya", "Migendezo", "Rudogo"],
    "Cyumba": ["Gasunzu", "Muhambo", "Nyambare", "Nyaruka", "Rwankonjo"],
    "Cyungo": ["Burehe", "Rwili"],
    "Cyuve": ["Bukinanyana", "Buruba", "Migeshi", "Rwebeya"],
    "Fumbwe": ["Mununu", "Nyagasambu", "Nyakagunga", "Sasabirago"],
    "Gacaca": ["Gakoro", "Gasakuza", "Kabirizi", "Karwasa"],
    "Gacurabwenge": ["Kigembe", "Nkingo"],
    "Gahanga": ["Gahanga", "Karembure", "Murinja", "Nunga", "Rwabutenge"],
    "Gahara": ["Butezi", "Muhamba", "Murehe", "Nyagasenyi", "Nyakagezi", "Rubimba"],
    "Gahengeri": ["Gihumuza", "Kagezi", "Mutamwa", "Runyinya", "Rweri"],
    "Gahini": ["Juru", "Kahi", "Kiyenzi", "Urugarama"],
    "Gahunga": ["Gisizi", "Kidakama", "Nyangwe"],
    "Gakenke": ["Buheta", "Kagoma", "Rusagara"],
    "Gasaka": ["Kigeme", "Ngiryi", "Nyabivumu", "Nzega"],
    "Gasange": ["Kimana", "Teme", "Viro"],
    "Gashaki": ["Mbwe", "Muharuro"],
    "Gashanda": ["Cyerwa", "Giseri", "Munege", "Mutsindo"],
    "Gashari": ["Tongati"],
    "Gashenyi": ["Nyacyina", "Rukura"],
    "Gashonga": ["Birembo", "Buhokoro", "Kabakobwa", "Kacyuma", "Kamurehe", "Karemereye", "Muti", "Rusayo"],
    "Gashora": ["Kagomasi", "Ramiro"],
    "Gataraga": ["Gasizi", "Mudakama", "Murago", "Rubindi", "Rungu"],
    "Gatare": ["Bakopfu", "Mukongoro"],
    ...
    "Gatumba": ["Cyome", "Kamasiga"],
    "Gatunda": ["Cyagaju", "Nyamikamba", "Nyamirembe", "Nyangara", "Nyarurema", "Rwensheke"],
    "Gihango": ["Bugina", "Congo-nil", "Ruhingo", "Shyembe", "Teba"],
    "Giheke": ["Cyendajuru", "Gakomeye", "Giheke", "Ntura", "Rwega", "Shagasha", "Turambi"],
    "Gihombo": ["Gitwa"],
    "Gihundwe": ["Burunga", "Gatsiro", "Kagara", "Kamatita"],
    "Gikomero": ["Gicaca", "Kibara"],
    "Gikondo": [],
    "Gikonko": ["Cyiri", "Gikonko"],
    "Gikundamvura": ["Kizura", "Mpinga", "Nyamigina"],
    "Gisenyi": ["Amahoro", "Bugoyi", "Mbugangari", "Nengo", "Rubavu", "Umuganda"],
    "Gishali": ["Bwinsanga", "Cyinyana", "Gati", "Kavumu", "Ruhimbi", "Ruhunda"],
    "Gishamvu": ["Nyakibanda", "Nyumba"],
    "Gishubi": ["Nyakibungo", "Nyeranzi"],
    "Gishyita": ["Buhoro"],
    "Gisozi": [],
    "Gitambi": ["Cyingwa", "Gahungeri", "Hangabashi", "Mashesha"],
    "Gitega": ["Akabahizi", "Akabeza", "Gacyamo", "Kinyange"],
    "Gitesi": ["Kanunga", "Kirambo", "Nyamiringa", "Rwariro"],
    "Giti": ["Gatobotobo", "Tanda"],
    "Gitoki": ["Bukomane", "Cyabusheshe", "Karubungo", "Mpondwa", "Rubira"],
    "Gitovu": ["Mariba", "Runoga"],
    "Hindiro": ["Gatega", "Kajinge", "Marantima"],
    "Huye": ["Muyogoro", "Rukira"],
    "Jabana": ["Akamatamu", "Kidashya"],
    "Jali": ["Agateko", "Buhiza", "Nkusi", "Nyabuliba", "Nyamitanga"],
    "Janja": ["Gakindo", "Gashyamba", "Gatwa", "Karukungu"],
    "Jarama": ["Ihanika", "Jarama", "Kibimba", "Kigoma"],
    "Jenda": ["Kareba", "Nyirakigugu", "Rega"],
    "Jomba": ["Gasura", "Nyamitanzi"],
    "Juru": ["Kabukuba", "Mugorore", "Musovu", "Rwinume"],
    "Kabacuzi": ["Kibyimba", "Sholi"],
    "Kabagali": [],
    "Kabare": ["Cyarubare", "Gitara", "Rubumba"],
    "Kabarondo": ["Cyabajwa", "Cyinzovu", "Kabura", "Rusera"],
    "Kabarore": ["Kabarore", "Kabeza", "Marimba", "Nyabikiri", "Simbwa"],
    "Kabatwa": ["Basumba", "Batikoti", "Cyamvumba", "Gihorwe", "Myuga", "Ngando"],
    "Kabaya": ["Busunzu", "Nyenyeri"],
    "Kacyiru": ["Kamatamu", "Kamutwa", "Kibaza"],
    "Kaduha": [],
    "Kagano": ["Mubumbano", "Ninzi", "Shara"],
    "Kagarama": ["Kanserege", "Rukatsa"],
    "Kageyo": ["Busetsa", "Gituza", "Kintu", "Nyagisozi"],
    "Kagogo": ["Kabaya", "Kayenzi", "Kiringa"],
    "Kamabuye": ["Biharagu", "Burenge", "Kampeka", "Nyakayaga", "Tunda"],
    "Kamegeri": ["Bwama", "Kamegeri", "Kizi", "Nyarusiza", "Rususa"],
    "Kamembe": ["Cyangugu", "Gihundwe", "Kamashangi", "Kamurera"],
    "Kamubuga": ["Kamubuga", "Kidomo", "Mbatabata", "Rukore"],
    "Kanama": ["Kamuhoza", "Mahoko", "Musabike", "Rusongati", "Yungwe"],
    "Kaniga": ["Bugomba", "Gatoma", "Mulindi", "Nyarwambu", "Rukurura"],
    "Kanjongo": ["Kibogora", "Kigoya", "Raro", "Susa"],
    "Kanombe": ["Busanza"],
    "Kansi": ["Akaboti", "Sabusaro"],
    "Kanyinya": ["Nyamweru", "Nzove"],
    "Kanzenze": ["Kanyirabigogo", "Kirerema", "Nyamikongi", "Nyamirango", "Nyaruteme"],
    "Karago": ["Cyamabuye", "Gatagara", "Gihirwa", "Kadahenda"],
    "Karama": ["Bushara", "Cyenkwanzi", "Gikagati", "Gikundamvura", "Ndego", "Nyakiga"],
    "Karambi": ["Gasovu", "Gitwe", "Rushyarara"],
    "Karambo": ["Kanyanza"],
    "Karangazi": ["Kamate", "Kizirakome", "Mbare", "Musenyi", "Ndama", "Nyagashanga", "Rubagabaga", "Rwenyemera", "Rwisirabo"],
    "Karembo": ["Akaziba", "Karaba", "Nyamirambo"],
    "Karenge": ["Bicaca", "Kabasore", "Kangamba", "Nyabubare"],
    "Karengera": ["Gasayo", "Gashashi", "Higiro", "Miko", "Mwezi"],
    "Katabagemu": ["Bayigaburire", "Kaduha", "Kanyeganyege", "Katabagemu", "Nyakigando", "Rugazi", "Rutoma"],
    "Kavumu": ["Murinzi", "Nyamugeyo", "Tetero"],
    "Kayenzi": ["Cubi"],
    "Kayumbu": [],
    "Kazo": ["Birenga", "Gahurire", "Karama", "Kinyonzo", "Umukamba"],
    "Kibangu": ["Gisharu", "Rubyiniro", "Ryakanimba"],
    "Kibeho": ["Kibeho", "Mbasa"],
    "Kibilizi": ["Mututu", "Rwotso"],
    "Kibirizi": ["Gashiha", "Ruhunga", "Uwindekezi"],
    "Kibumbwe": ["Gakanka", "Kibibi", "Nyakiza"],
    "Kibungo": ["Cyasemakamba", "Gahima", "Gatonde", "Karenge", "Mahango"],
    "Kicukiro": ["Kicukiro"],
    "Kigabiro": ["Sibagire", "Sovu"],
    "Kigali": ["Kigali", "Ruriba"],
    "Kigarama": ["Cyanya", "Kigarama", "Kiremera", "Nyakerera", "Nyankurazo"],
    "Kigembe": ["Agahabwa", "Impinga", "Nyabikenke"],
    "Kigeyo": ["Buhindure", "Nkora", "Nyagahinika", "Rukaragata"],
    "Kigina": ["Gatarama", "Ruhanga", "Rwanteru"],
    "Kigoma": ["Gishihe", "Kabatwa", "Musebeya"],
    "Kimihurura": ["Kamukina", "Kimihurura", "Rugando"],
    "Kimironko": ["Kibagabaga"],
    "Kimisagara": ["Katabaro", "Kimisagara"],
    "Kimonyi": ["Birira", "Buramira", "Mbizi"],
    "Kinazi": ["Burima", "Gisali", "Kinazi"],
    "Kinigi": ["Bisoke", "Kaguhu", "Kampanga", "Nyabigoma", "Nyonirima"],
    "Kinihira": ["Butunzi", "Karegamazi", "Marembo"],
    "Kinoni": ["Gafuka", "Nkenke", "Nkumba"],
    "Kintobo": ["Gatovu", "Kintobo", "Rukondo", "Ryinyo"],
    "Kinyababa": ["Kaganda", "Musasa", "Rutovu"],
    "Kinyinya": ["Gacuriro", "Kagugu"],
    "Kiramuruzi": ["Akabuga", "Gakenke", "Gakoni", "Nyabisindu"],
    "Kirehe": ["Gahama", "Kirehe", "Nyabigega", "Nyabikokora", "Rwesero"],
    "Kirimbi": ["Cyimpindu", "Karengera"],
    "Kisaro": ["Gitatsa", "Kamushenyi", "Sayo"],
    "Kitabi": ["Mujuga", "Mukungu", "Shaba", "Uwingugu"],
    "Kivu": ["Cyanyirankora", "Gahurizo", "Kimina", "Kivu"],
    "Kivumu": ["Bunyoni", "Bunyunju", "Kabere", "Kabujenje"],
    "Kivuruga": ["Cyintare", "Rugimbu", "Ruhinga", "Sereri"],
    "Kivuye": ["Bukwashuri", "Gashanje", "Murwa", "Nyirataba"],
    "Kiyombe": ["Gataba", "Gitenga", "Kabungo", "Karambo", "Karujumba", "Tovu"],
    "Kiyumba": ["Budende", "Ruhina", "Rukeri"],
    "Kiziguro": ["Agakomeye", "Mbogo", "Ndatemwa", "Rubona"],
    "Macuba": ["Mutongo", "Nyakabingo", "Vugangoma"],
    "Mageregere": ["Kankuba", "Ntungamo", "Nyarufunzo", "Nyarurenzi", "Runzenze"],
    "Mahama": ["Kamombo", "Mwoga", "Saruhembe", "Umunini"],
    "Mahembe": ["Gisoke", "Nyakavumu"],
    "Mamba": ["Kabumbwe", "Mamba", "Muyaga"],
    "Manihira": ["Haniro", "Muyira", "Tangabo"],
    "Manyagiro": ["Nyiragifumba", "Nyiravugiza", "Rusekera", "Ryaruyumba"],
    "Maraba": ["Buremera", "Gasumba", "Shanga"],
    "Mareba": ["Rango"],
    "Masaka": ["Ayabaraya", "Cyimo", "Mbabe", "Rusheshe"],
    "Masoro": ["Nyamyumba", "Shengampuli"],
    "Mata": ["Gorwe", "Ramba"],
    "Mataba": ["Buyange", "Gikombe"],
    "Matimba": ["Bwera", "Cyembogo", "Kagitumba", "Kanyonza", "Matimba", "Nyabwishongwezi", "Rwentanga"],
    "Matyazo": ["Binana", "Rwamiko"],
    "Mayange": ["Gakamba", "Kagenge", "Mbyo"],
    "Mbazi": ["Manwari", "Mutiwingoma", "Ngambi", "Ngara"],
    "Mbogo": ["Bukoro", "Mushari", "Ngiramazi"],
    "Mbuye": ["Cyanza", "Gisanga", "Kizibere", "Nyakarekare"],
    "Mimuri": ["Gakoma", "Mahoro", "Mimuri", "Rugari"],
    "Minazi": ["Gasiho"],
    "Miyove": ["Miyove"],
    "Mpanga": ["Bwiyorere", "Kankobwa", "Mpanga", "Mushongi", "Nasho", "Nyakabungo", "Rubaya"],
    "Mubuga": ["Kagabiro", "Murangara", "Ryaruhanga"],
    "Mudende": ["Bihungwe", "Kanyundo", "Micinyiro", "Mirindi", "Ndoranyi", "Rwanyakayaga"],
    ...
    "Mugunga": ["Munyana", "Mutego", "Nkomane", "Rutabo", "Rutenderi", "Rwamambe"],
    "Muhanda": ["Mashya", "Ngoma", "Rutagara"],
    "Muhanga": ["Kanyinya"],
    "Muhazi": ["Byeza", "Karitutu", "Kitazigurwa", "Nsinda", "Nyarusange"],
    "Muhima": ["Kabasengerezi", "Nyabugogo", "Rugenge", "Ubumwe"],
    "Muhondo": ["Busake", "Bwenda", "Huro", "Musagara", "Ruganda", "Rwinkuba"],
    "Muhororo": ["Bweramana", "Myiha", "Rugogwe", "Rusororo", "Sanza"],
    "Muhoza": ["Cyabararika", "Kigombe", "Mpenge", "Ruhengeri"],
    "Muhura": ["Bibare", "Gakorokombe", "Mamfu", "Rumuli", "Taba"],
    "Mukama": ["Bufunda", "Gatete", "Gihengeri", "Gishororo", "Kagina"],
    "Mukamira": ["Jaba", "Kanyove", "Rukoma", "Rurengeri"],
    "Mukarange": ["Bwiza", "Kayonza", "Mburabuturo", "Nyagatovu", "Rugendabari"],
    "Mukindo": ["Mukiza", "Nyabisagara"],
    "Mukingo": ["Cyerezo", "Kiruli", "Ngwa", "Nkomero"],
    "Muko": ["Cyamuhinda", "Mwendo", "Ngange"],
    "Mukura": ["Kagusa", "Rufungo"],
    "Munini": ["Giheta", "Ngarurira", "Ngeri", "Ntwali", "Nyarure"],
    "Munyaga": ["Nkungu", "Rweru", "Zinga"],
    "Munyiginya": ["Binunga", "Bwana", "Cyarukamba", "Cyimbazi", "Nkomangwa", "Nyarubuye"],
    "Murama": ["Gitaraga", "Kigabiro", "Mvumba", "Sakara"],
    "Murambi": ["Nyamiyaga", "Rwankuba", "Rwimitereri"],
    "Muringa": ["Mulinga", "Mwiyanike", "Nyamasheke", "Rwantobo"],
    "Murunda": ["Mburamazi", "Rugeyo", "Twabugezi"],
    "Murundi": ["Buhabwa", "Murundi", "Ryamanyoni"],
    "Mururu": ["Kabahinda", "Kabasigirira", "Tara"],
    "Musambira": ["Mpushi", "Rukambura"],
    "Musange": ["Masagara", "Masizi"],
    "Musanze": ["Cyabagarura", "Garuka", "Kabazungu"],
    "Musasa": [],
    "Musaza": ["Gasarabwayi", "Kabuga", "Mubuga", "Musaza", "Nganda"],
    "Musebeya": ["Nyarurambi", "Rugano", "Runege", "Sekera"],
    "Musenyi": ["Nyagihunika", "Rulindo"],
    "Musha": ["Akabare", "Budahanda", "Kagarama", "Musha", "Nyakabanda"],
    "Musheri": ["Kibirizi", "Kijojo", "Musheri", "Nyagatabire", "Nyamiyonga", "Rugarama i", "Rugarama ii"],
    "Mushikiri": ["Bisagara", "Cyamigurwa", "Rugarama", "Rwanyamuhanga", "Rwayikona"],
    "Mushishiro": ["Matyazo", "Munazi", "Nyagasozi", "Rwasare", "Rwigerero"],
    "Mushonyi": ["Biruyi", "Kaguriro", "Magaba", "Rurara"],
    "Mushubati": ["Cyarusera", "Mageragere", "Sure"],
    "Mushubi": ["Buteteri", "Cyobe", "Gashwati"],
    "Mutenderi": ["Karwema", "Mutenderi", "Muzingira"],
    "Mutete": ["Gaseke", "Mutandi"],
    "Mutuntu": ["Byogo", "Gisayura", "Kanyege", "Kinyonzwe", "Murengezo", "Rwufi"],
    "Muyira": ["Migina", "Nyamure"],
    "Muyongwe": ["Bumba", "Karyango", "Nganzo", "Va"],
    "Muyumbu": ["Akinyambo", "Bujyujyu", "Ntebe", "Nyarukombe"],
    "Muzo": ["Kabatezi", "Kiryamo", "Mwiyando", "Rwa"],
    "Mwendo": ["Gafunzo", "Gishweru", "Kamujisho", "Kubutare", "Mutara", "Nyabibugu", "Saruheshyi"],
    "Mwiri": ["Kageyo", "Migera", "Nyawera"],
    "Mwogo": ["Bitaba", "Rugunga"],
    ...
    "Ndera": ["Cyaruzinge", "Masoro", "Mukuyu", "Rudashya"],
    "Ndora": ["Bweya", "Cyamukuza", "Dahwe", "Gisagara", "Mukande"],
    "Nduba": ["Gasanze", "Gatunga", "Muremure", "Sha", "Shango"],
    "Nemba": ["Rushara"],
    "Ngamba": ["Kazirabonde"],
    "Ngarama": ["Bugamba", "Kigasha", "Ngarama", "Nyarubungo"],
    "Ngera": ["Mukuge"],
    "Ngeruka": ["Ngeruka", "Nyakayenzi"],
    "Ngoma": ["Mugote", "Munyarwanda"],
    "Ngororero": ["Kaseke", "Kazabe", "Mugano", "Torero"],
    "Niboye": ["Niboye"],
    "Nkanka": ["Kamanyenga", "Kangazi", "Kinyaga", "Rugabano"],
    "Nkomane": ["Bitandara", "Musaraba", "Mutengeri", "Nyarwungo", "Shyeru", "Twiya"],
    ...
    "Ntongwe": ["Kebero", "Nyarurama"],
    "Ntyazo": ["Bugali", "Kagunga", "Katarara"],
    "Nyabimata": ["Gihemvu", "Mishungero", "Nyabimata"],
    "Nyabinoni": ["Gashorera", "Masangano", "Mbuga", "Muvumba", "Nyarusozi"],
    "Nyabirasi": ["Busuku"],
    "Nyabitekeri": ["Kinunga", "Muyange", "Ntango"],
    ...
    "Nyagisozi": ["Maraba", "Mwoya", "Nkakwa"],
    "Nyakabanda": ["Kabuguru i", "Munanira i", "Munanira ii", "Nyakabanda i", "Nyakabanda ii"],
    "Nyakabuye": ["Gasebeya", "Kamanu", "Kiziho", "Mashyuza", "Nyabintare"],
    "Nyakaliro": ["Bihembe", "Gishore", "Rwimbogo"],
    "Nyakarenzo": ["Kabagina", "Kanoga", "Karangiro", "Rusambu", "Ryamuhirwa"],
    "Nyakiriba": ["Bisizi", "Kanyefurwe", "Nyarushyamba"],
    "Nyamabuye": ["Gahogo", "Gifumba"],
    "Nyamata": ["Kayumba", "Maranyundo", "Nyamata y' umujyi"],
    "Nyamirama": ["Gikaya", "Musumba", "Rurambi", "Shyogo"],
    "Nyamirambo": ["Mumena"],
    "Nyamiyaga": ["Gahumuliza", "Jamba", "Kiziba", "Mataba"],
    "Nyamugari": ["Bukora", "Kagasa", "Kazizi", "Kiyanzi"],
    "Nyamyumba": ["Burushya", "Kinigi", "Kiraga"],
    "Nyange": ["Cyivugiza", "Kamwumba", "Muhabura", "Ninda"],
    "Nyankenke": ["Butare", "Kigogo", "Kinishya", "Rusasa", "Rutete", "Rwagihura", "Yaramba"],
    "Nyanza": ["Nyaruteja", "Umubanga"],
    "Nyarubaka": ["Kambyeyi", "Kigusa", "Nyagishubi", "Ruyanza"],
    "Nyarubuye": ["Mareba", "Nyabitare", "Nyarutunga"],
    "Nyarugenge": ["Ngenda"],
    "Nyarugunga": ["Kamashashi", "Nonko"],
    "Nyarusange": ["Mbiriri", "Musongati", "Ngaru", "Rusovu"],
    "Nyundo": ["Bahimba", "Kavomo", "Mukondo", "Terimbere"],
    "Nzahaha": ["Butambamo", "Kigenge", "Murya", "Nyenji", "Rwinzuki"],
    "Nzige": ["Akanzu"],
    "Rambura": ["Guriro", "Kibisabo", "Mutaho", "Rugamba"],
    "Rangiro": ["Banda", "Jurwe"],
    "Remera": ["Bugera", "Ndekwe"],
    "Rilima": ["Karera", "Kimaranzara", "Ntarama", "Nyabagendwa"],
    "Rongi": ["Gasagara", "Ruhango"],
    "Rubavu": ["Buhaza", "Burinda", "Byahi", "Murara", "Rukoko"],
    "Rubaya": ["Gihanga", "Gishambashayo", "Gishari", "Muguramo"],
    "Rubengera": ["Bubazi", "Gacaca", "Gisanze", "Nyarugenge", "Ruragwe"],
    "Rubona": ["Byinza", "Kabatasi", "Kabuye", "Mabare", "Nawe"],
    "Rugabano": ["Mucyimba", "Rwungo"],
    "Ruganda": ["Biguhu", "Kabingo", "Kinyovu", "Nyabikeri", "Nyamugwagwa", "Rugobagoba"],
    "Rugarama": ["Bugarama", "Gihuta", "Kanyangese", "Matare", "Matunguru", "Remera"],
    "Rugarika": ["Kigese", "Masaka", "Sheli"],
    "Rugendabari": ["Gasave", "Kibaga", "Nsanga"],
    "Rugengabari": ["Kilibata", "Mucaca", "Nyanamo", "Rukandabyuma"],
    "Rugera": ["Marangara", "Nyagahondo", "Nyarutembe", "Tyazo"],
    "Rugerero": ["Basa", "Gisa", "Kabilizi", "Muhira", "Rushubi"],
    "Ruhango": ["Gihira", "Nyakarera", "Rugasa", "Rundoyi"],
    "Ruharambuga": ["Kanazi", "Ntendezi", "Save", "Wimana"],
    "Ruhashya": ["Busheshi", "Mara", "Ruhashya"],
    "Ruheru": ["Gitita", "Uwumusebeya"],
    "Ruhuha": ["Bihari", "Gatanga", "Kindama", "Ruhuha"],
    "Ruhunde": ["Gatare", "Gitovu"],
    "Rukara": ["Kawangire", "Rukara", "Rwimishinya"],
    "Rukira": ["Buliba", "Kibatsi", "Nyaruvumu", "Nyinya"],
    "Rukoma": ["Bugoba", "Buguri", "Gishyeshye", "Mwirute"],
    "Rukomo": ["Gahurura", "Gashenyi", "Nyakagarama", "Rukomo ii"],
    "Rukozo": ["Buraro", "Bwimo", "Mberuka", "Mbuye"],
    "Rukumberi": ["Ntovi", "Rubago", "Rwintashya"],
    "Ruli": ["Busoro", "Gikingo", "Jango", "Ruli"],
    "Runda": ["Gihara", "Kabagesera", "Ruyenzi"],
    "Ruramba": ["Giseke", "Nyarugano", "Ruramba"],
    "Ruramira": ["Bugambira", "Nkamba", "Ruyonza", "Umubuga"],
    "Rurembo": ["Gahondo", "Kirimbogo", "Mwana", "Rwaza"],
    "Rurenge": ["Akagarama", "Muhurire", "Musya", "Rugese", "Rujambara", "Rwikubo"],
    "Rusarabuye": ["Kabona", "Ndago"],
    "Rusasa": ["Kamonyi", "Nyundo", "Rumbi"],
    "Rusatira": ["Buhimba", "Kimirehe", "Kimuna", "Mugogwe"],
    "Rusebeya": ["Mberi", "Ruronde"],
    "Rusenge": ["Bunge", "Cyuna", "Gikunzi", "Raranzige", "Rusenge"],
    "Rushaki": ["Gitega", "Kamutora", "Karurama"],
    "Rushashi": ["Burimba", "Busanane", "Joma", "Raba", "Razi", "Shyombwe"],
    "Rusiga": ["Gako", "Kirenge"],
    "Rusororo": ["Bisenga", "Kabuga i", "Kabuga ii", "Kinyana", "Mbandazi"],
    "Rutare": ["Bikumba", "Gasharu", "Gatwaro", "Munanira", "Nkoto"],
    "Rutunga": ["Gasabo", "Indatemwa", "Kabaliza", "Kacyatwa", "Kibenga"],
    "Ruvune": ["Cyandaro", "Gasambya", "Gashirira", "Rebero", "Ruhondo"],
    "Rwabicuma": ["Gacu", "Gishike", "Mushirarungu", "Runga"],
    "Rwamiko": ["Cyeru", "Nyagahinga"],
    "Rwaniro": ["Kamwambi", "Kibiraro", "Nyaruhombo", "Shyunga"],
    "Rwankuba": ["Bigugu", "Bisesero", "Gasata", "Nyakamira", "Nyarusanga", "Rubazo"],
    "Rwaza": ["Bumara", "Kabushinge", "Musezero", "Nturo"],
    "Rwempasha": ["Cyenjonjo", "Gasinga", "Kabare", "Kazaza", "Mishenyi", "Rukorota", "Rutare", "Rwempasha", "Ryeru"],
    "Rwerere": ["Gacundura", "Gashoro", "Ruconsho"],
    "Rweru": ["Batima", "Kintambwe", "Mazane", "Nemba", "Nkanga", "Sharita"],
    "Rwezamenyo": ["Kabuguru ii", "Rwezamenyo i", "Rwezamenyo ii"],
    "Rwimbogo": ["Kiburara", "Munini", "Nyamatete", "Rwikiniro"],
    "Rwimiyaga": ["Gacundezi", "Kirebe", "Ntoma", "Nyarupfubire", "Nyendo", "Rutungu", "Rwimiyaga"],
    "Rwinkwavu": ["Gihinga", "Mbarara", "Mukoyoyo", "Nkondo"],
    "Sake": ["Kibonde"],
    "Save": ["Gatoki", "Rwanza", "Shyanda", "Zivu"],
    "Shangasha": ["Nyabishambi", "Shangasha"],
    "Shangi": ["Shangi"],
    "Shingiro": ["Gakingo", "Kibuguzo", "Mudende", "Mugari"],
    "Shyara": ["Kabagugu", "Kamabuye", "Nziranziza"],
    "Shyira": ["Cyimanzovu", "Kanyamitana", "Kintarure", "Shaki"],
    "Shyogwe": ["Kinini"],
    "Shyrongi": ["Bugaragara", "Kijabagwe", "Muvumu", "Rutonde"],
    "Simbi": ["Gisakura", "Kabusanza", "Mugobore", "Nyangazi"],
    "Sovu": ["Kagano", "Kanyana", "Nyabipfura"],
    "Tabagwe": ["Gishuro", "Gitengure", "Nkoma", "Nyabitekeri", "Nyagatoma", "Shonga", "Tabagwe"],
    "Tare": ["Gasarenda", "Kaganza", "Nkumbure"],
    "Tumba": ["Barari", "Gahabwa", "Misezero", "Nyirabirori"],
    "Twumba": ["Bihumbe", "Gakuta", "Gitabura", "Rutabi"],
    "Uwinkingi": ["Bigumira", "Gahira", "Kibyagira", "Mudasomwa", "Munyege"],
    "Zaza": ["Nyagatugunda", "Ruhembe"],
}
